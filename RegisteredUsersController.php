...
class RegisteredUsersController extends PluginController {
    ...
    public function edit_settings() {
        ...
        $connect_secret_key = mysql_real_escape_string($_POST['connect_secret_key']);
        $random_key_length = mysql_real_escape_string($_POST['random_key_length']);
        $random_key_type = mysql_real_escape_string($_POST['random_key_type']);
        $login_closed_message = mysql_real_escape_string($_POST['login_closed_message']);
        $register_page = mysql_real_escape_string($_POST['register_page']);
        $already_logged_in = mysql_real_escape_string($_POST['already_logged_in']);
        $default_permissions = mysql_real_escape_string($_POST['default_permissions']);
        $welcome_email_pt = mysql_real_escape_string($_POST['welcome_email_pt']);
        $register_confirm_msg = mysql_real_escape_string($_POST['register_confirm_msg']);
        $welcome_email_pt_foot = mysql_real_escape_string($_POST['welcome_email_pt_foot']);
        $confirm_email_subject = mysql_real_escape_string($_POST['confirm_email_subject']);
        ...
        $message_empty_password = mysql_real_escape_string($_POST['message_empty_password']);
        $message_empty_password_confirm = mysql_real_escape_string($_POST['message_empty_password_confirm']);
        $message_notvalid_password = mysql_real_escape_string($_POST['message_notvalid_password']);
        $message_notvalid_username = mysql_real_escape_string($_POST['message_notvalid_username']);
        $message_notvalid_email = mysql_real_escape_string($_POST['message_notvalid_email']);
        $message_error_technical = mysql_real_escape_string($_POST['message_error_technical']);
        $message_error_already_validated = mysql_real_escape_string($_POST['message_error_already_validated']);
        $message_need_to_register = mysql_real_escape_string($_POST['message_need_to_register']);
        $auth_required_page = mysql_real_escape_string($_POST['auth_required_page']);
        $auth_required_page_text = mysql_real_escape_string($_POST['auth_required_page_text']);
        $reset_text = mysql_real_escape_string($_POST['reset_text']);
        $reset_no_email = mysql_real_escape_string($_POST['reset_no_email']);
        $reset_pass_length = mysql_real_escape_string($_POST['reset_pass_length']);
        $reset_pass_type = mysql_real_escape_string($_POST['reset_pass_type']);
        $reset_email_body = mysql_real_escape_string($_POST['reset_email_body']);
        $reset_password_reply = mysql_real_escape_string($_POST['reset_password_reply']);
        $reset_password_from = mysql_real_escape_string($_POST['reset_password_from']);
        $reset_password_subject = mysql_real_escape_string($_POST['reset_password_subject']);
        $reset_email_confirmed = mysql_real_escape_string($_POST['reset_email_confirmed']);
        $welcome_message = mysql_real_escape_string($_POST['welcome_message']);
